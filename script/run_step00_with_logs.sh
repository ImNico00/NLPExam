...
RUNS_DIR="${RUNS_DIR:-pipeline_exam/run_logs/pipeline_step00_runs}"
RUN_DIR="${RUNS_DIR}/${RUN_ID}"
LOG_FILE="${RUN_DIR}/pipeline_step00.log"
...
COMMAND=(
  ...
  "${PYTHON_BIN}"
  -m
  pipeline_exam.src.step00_creation
  "$@"
)
...
echo "[${RUN_ID}] starting Pipeline step00"
